...
def OC():
    oc = {"Oficial de cumplimiento" : ["Elaborar y someter a consideracion el manual", "Someter aprobracion la metodologia", "Enviar reportes op", "Hacer conocimiento al comite las cuentas de alto riesgo",
    ...
    pregunta = "Funciones del "
    calificacion = funcion_preguntas.preguntas_list(oc, tema, pregunta)
    return calificacion
    
def CCC():
    ccc = {"Comite de Comunicacion y control" : ["Aprobar Manual de cumplimiento", "Presentar la metodologia elaborada e implementada al administrador", "Conocer los resultados de la auditoria interna",
    ...
    pregunta = "Funciones del "
    calificacion = funcion_preguntas.preguntas_list(ccc, tema, pregunta)
    return calificacion
